...
var death_rate_US = {
    equation: 4 * time,  
    sentence: defaultSentence + ", " + equation + " has died in the US.",
...
var death_rate_canada = {
    equation: 1.8 * time,  
    sentence: defaultSentence + ", " + equation + " has died in the Canada.",
...
var birth_rate = {
    equation: 2 * time,
    sentence: defaultSentence + ", " + equation + " have been born in the US.",
...
var oil_consumption = {
    equation: 1110 * time, 
    sentence: defaultSentence + ", " + equation + " barrels of oil has been consumed.",
...
var tortoise_movement = {
    equation: 0.075 * time, 
    sentence: defaultSentence + ", a turtle has moved " + equation + ", meters.",
...
var elephant_heartbeats = {
    equation: 0.5 * time,
    sentence: defaultSentence + ", " + equation + " an elephant's heart has beated.",
...
var hunger_deaths = {
    equation: 0.25 * time,
    sentence: defaultSentence + ", " + equation + " people has died.",
...
var starfish = {
    equation: 0.25 * time,
    sentence: defaultSentence + ", a starfish has moved " + equation + " in distance.",
...
var cancer_deaths = {
    equation: 0.20 * time, 
    sentence: defaultSentence + ", " + equation + " has died from cancer.",
